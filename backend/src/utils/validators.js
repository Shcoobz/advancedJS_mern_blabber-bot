...
function validate(validations) {
    var runValidations = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, validations_1, validation, result, errors, error;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (errors.isEmpty()) {
                            ...
                            error = new Error(constants_js_1.ERROR.VALIDATION.FAILED);
                            error.name = constants_js_1.ERROR.VALIDATION.ERROR_NAME;
                            error.message = JSON.stringify(errors.array());
                            return [2 /*return*/, (0, user_handler_js_1.sendErrorResponse)(res, error, 422)];
                        }
                        return [2 /*return*/];
                }
            });
